...
public interface ContactConstants {
    ...
    public static final String GET_CONTACTS_BY_ID_OP_DESC = "Retrieve specific contact";
    public static final String GET_CONTACTS_BY_ID_OP_200_DESC = "Successful, returning requested contact";
    public static final String GET_CONTACTS_BY_ID_OP_403_DESC = "Only user's can retrieve a specific contact";
    public static final String GET_CONTACTS_BY_ID_OP_404_DESC = "Requested contact not found";
    public static final String GET_CONTACTS_OP_403_DESC_JSON_MSG =
        PREFIX_JSON_MSG + GET_CONTACTS_BY_ID_OP_403_DESC + SUFFIX_JSON_MSG;
